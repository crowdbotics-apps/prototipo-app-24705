"""prototipo_app_24705 URL Configuration
...
admin.site.site_header = "prototipo-app"
admin.site.site_title = "prototipo-app Admin Portal"
admin.site.index_title = "prototipo-app Admin"

# swagger
api_info = openapi.Info(
    title="prototipo-app API",
    default_version="v1",
    description="API documentation for prototipo-app App",
)
